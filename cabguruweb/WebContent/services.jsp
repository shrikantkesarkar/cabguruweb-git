					...
					<div class="span6">
						<div class="area">
							...
							<form class="form-horizontal">
								<div class="heading">
									<h4 class="form-heading">Our Services</h4>
								</div>



								<ul class="list-services">
									<li><img class="img-circle img-responsive text-center"
										src="img/limo-1-small.jpg" alt="">
										<div>
											<p class="lead">Limo Services</p>

										</div></li>
									<li><img class="img-circle img-responsive text-center"
										src="img/airport-taxi-small.jpg" alt="">
										<div>
											<p class="lead">Airport Services</p>

										</div></li>
									<li><img class="img-circle img-responsive text-center"
										src="img/tourists-1-small.jpg" alt="">
										<div>
											<p class="lead">Tourist Services</p>
					...
					<div class="span6">
						<div class="area">
							<form class="form-horizontal">
								...
								<ul class="list-services">
									<li><img class="img-circle img-responsive text-center"
										src="img/medical-1-small.jpg" alt="">
										<div>
											<p class="lead">Medical Transportation</p>

										</div></li>
									<li><img class="img-circle img-responsive text-center"
										src="img/school-1-small.gif" alt="">
										<div>
											<p class="lead">School Routing</p>

										</div></li>
									<li><img class="img-circle img-responsive text-center"
										src="img/outings-1-small.jpg" alt="">
										<div>
											<p class="lead">Private Outings</p>
