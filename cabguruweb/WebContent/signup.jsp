...
<head>
<meta charset="utf-8">
<title>ITaxi-SignUp &middot;</title>
...
<body>
					...
					<div class="span6">
						<div class="area">
							<form class="form-horizontal" accept-charset="UTF-8" role="form"
								method="POST" action="/cabguruweb/ls">
								<div class="heading">
                            ...
                            <div class="controls">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="inputUsername" placeholder="Mobile Number"
	...
	<script>
		...
		function initializeAddr() {
			  ...
			  userAddress = new google.maps.places.Autocomplete(
			      /** @type {HTMLInputElement} */(document.getElementById('userAddr')),
			      { types: ['geocode'] });
